...
el.style.cssText='position:fixed;z-index:2147483647;right:16px;bottom:16px;max-width:360px;padding:12px 14px;background:#131313;color:#c58a24;font:13px system-ui;border-radius:8px;white-space:pre-line';
