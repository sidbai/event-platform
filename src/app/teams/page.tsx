...
import { MergePicker } from "@/features/teams/merge-picker";
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-10">
      ...
      <section className="mt-8">
        ...
        {/*
          An admin searching a club can see that five rows are one team, and
          the duplicate queue is the wrong tool for that: it asks about pairs,
          carefully, because it is guessing. Here somebody already knows.
        */}
        {admin ? (
          <MergePicker teams={others} merge={confirmMerge} />
        ) : (
